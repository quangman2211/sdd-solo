...
| Nhiều agent trên một repo (A/B/C/R/V/D/T/Q, sổ hỏi đáp L0–L3, chuỗi T→D→C→R→spec‖D‖T) | `/sdd-solo:orchestrate setup` rồi `/sdd-solo:orchestrate UC-###` (6.6.0, #39) |
...
└── plugins/sdd-solo/
    ...
    ├── skills/  sdd-process · init · intake · start · adversarial · verify · gate · design · change · close · deprecate · orchestrate · state · status
