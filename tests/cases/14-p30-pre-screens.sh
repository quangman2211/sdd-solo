...
xfail P-30 "--pre đỏ khi E1 không có dòng trong ## Screens (được exit $R)" '[ $R = 1 ] && has "E1 chưa có dòng"'
cm "docs(UC-001): đọc lại — bỏ dòng E1" 2026-01-06
S gate-check.sh UC-001
chk "cổng đầy đủ đỏ E1 chưa có dòng (exit $R)" '[ $R = 1 ] && has "E1 chưa có dòng"'
