...
chk "stop với tên chưa khai → cảnh báo (exit $R)" '[ $R = 0 ] && has "chưa khai ở notes/uy-quyen.md"'
S status.sh
chk "status: DỪNG-S9 không khai → đỏ" 'has "hàng đợi có DỪNG-S9 nhưng notes/uy-quyen.md"'
chk "status: Phạm vi còn khuôn → nhắc" 'has "Phạm vi còn khuôn"'
S queue.sh stop b-uc-001-p1 S1 "cần push"
S status.sh
chk "status: DỪNG-S1 có khai → ✓" 'has "DỪNG-S1 có khai"'
app notes/uy-quyen.md "| 2026-01-10 | Ngưỡng thử lại | 3 lần | RULE-001 | #9 · decisions |"
S status.sh
chk "status: Sổ trỏ #9 mà decisions.md không có → cảnh báo" 'has "trỏ phiếu #9 nhưng decisions.md không có"'
app specs/decisions.md "- 2026-01-10 — Ngưỡng thử lại 3 lần (A theo uỷ quyền, phiếu #9). Loại: không giới hạn. Chi tiết: RULE-001"
S status.sh
chk "decisions.md có #9 → hết cảnh báo" '! has "trỏ phiếu #9 nhưng"'
