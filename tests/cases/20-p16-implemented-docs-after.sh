...
chk "P-16 · (b) đã nén: không đỏ §9 'chưa đọc lại' trên UC implemented" '! has "chưa đọc lại bằng đầu chưa neo"'
nr p16a
...
cm "docs(UC-001): sửa Dependencies" 2026-01-13
S gate-check.sh UC-001
chk "P-16 · (a) chưa nén: không đỏ 'spec đổi HÀNH VI' vì vùng đổi nằm trước commit đóng" '! has "spec đổi HÀNH VI"'
...
S gate-check.sh UC-001
chk "AC đổi sau commit đóng → cổng nói 'sau khi đóng UC' + Phase 5" 'has "sau khi đóng UC" && has "Phase 5"'
