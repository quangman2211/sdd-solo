...
- **chiều ghi** — không bỏ chiều ghi (đẩy đơn lên sàn)
- **nhiều sàn** — không phụ thuộc một sàn duy nhất
- **không terminal** — seller không phải mở terminal
...
| orders | lát 1 "báo đơn" | BR-001 | đang làm | — |
