...
3. Context (`$2`): nếu không có, liệt kê `specs/contexts/*/` và hỏi user chọn **bằng `AskUserQuestion`** (mỗi context một lựa chọn, thêm lựa chọn "tạo context mới từ `${CLAUDE_PLUGIN_ROOT}/templates/skel/context/`").
